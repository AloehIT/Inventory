...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <form action="{{ route('posts.barangmasuk') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="col-xl-12">
                <div class="card p-4">
            ...
            <div class="card">
                <div class="card-body d-flex flex-row justify-content-between mt-0">
                    <div class="col-lg-9">
                        ...
                        <div class="d-flex">
                            <a href="{{ url('app/barang-masuk') }}" class="btn btn-sm text-white" style="background: red;"><i class="bi bi-x-lg"></i> Tutup</a>
                            <a href="" class="btn btn-sm text-white mx-1" style="background: blue;"><i class="bi bi-download"></i> Rekam</a>
                        </div>
                    </div>
                    <div class="col-lg-3">

...
@section('subtitle', 'Laporan Barang Masuk')
                ...
                <div class="card-body">
                    <div class="row justify-content-between">
                        <div class="col-lg-6 col-md-6  col-12 py-3">
                            <h3 class="text-dark">@yield('title') ERP <i class="bi bi-box-arrow-in-left text-success"></i></h3>
                        ...
                        <div class="card">
                            <div class="card-body p-4">
                                <div class="ml-auto text-end">
                                    <a href="javascript:void(0)" class="btn btn-danger" id="print-barang-masuk"><i class="uil-print"></i> Print PDF</a>
                                </div>

...
$(document).ready(function() {
    ...
    function printPDF() {
        ...
        $.ajax({
            url: '/laporan-barang-masuk/print-barang-masuk',
            method: 'GET',
            data: {
    ...
    function exportExcel() {
        ...
        $.ajax({
            url: '/laporan-barang-masuk/export-barang-masuk',
            method: 'GET',
            data: {
                selected_barcode: selectedBarcode,
                start_date: $('#start_date').val(),
            ...
            success: function(response) {
                ...
                link.href = blobUrl;
                link.download = 'laporan-barang-masuk.xlsx';
